...
class VaccinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post vaccinations_url, params: { vaccination: { disease_id: @vaccination.disease_id, duration: @vaccination.duration, e_information: @vaccination.e_information } }
    end
  ...
  test "should update vaccination" do
    patch vaccination_url(@vaccination), params: { vaccination: { disease_id: @vaccination.disease_id, duration: @vaccination.duration, e_information: @vaccination.e_information } }
