class AddProvinceFromSouthAfrica < ActiveRecord::Migration[5.0]

    def up
      from_shp_sql =  `shp2pgsql -c -g geom -W LATIN1 -s 4326 C:\\shpfiles\\SouthAfrica\\gadm36_ZAF_1.shp province_ref`
