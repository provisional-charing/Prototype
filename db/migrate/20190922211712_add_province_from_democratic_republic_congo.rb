class AddProvinceFromDemocraticRepublicCongo < ActiveRecord::Migration[5.0]

    def up
      from_shp_sql =`shp2pgsql -c -g geom -W LATIN1 -s 4326 C:\\shpfiles\\DemocraticRepubliceKongo\\gadm36_COD_1.shp province_ref`
